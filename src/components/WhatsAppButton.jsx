export default function WhatsAppButton() {
    // Reemplaza con tu número de WhatsApp (código de país + número sin +)
    const phoneNumber = "56912345678"; // Ejemplo: Chile 569 + tu número
    const message = "Hola, me interesa conocer más sobre sus productos 3D impresos";

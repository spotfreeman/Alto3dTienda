...
// Importing images
import { imgGeneral } from './assets/images/images'

// Importing data
import { collections, trendingProducts } from './data/products'
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route
          path="/producto/:id"
          element={<ProductDetail products={trendingProducts} />}
        />
      </Routes>
    </Router>
  )
